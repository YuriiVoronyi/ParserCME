...
public class Summary extends BasePage{
    ...
    //Неделя      ctl00_ucSelector_lvGroupsExpirations_ctrl5_lvExpirations_ctrl0_lbExpiration
    //Понедельник ctl00_ucSelector_lvGroupsExpirations_ctrl1_lvExpirations_ctrl0_lbExpiration
    //Вторник     ctl00_ucSelector_lvGroupsExpirations_ctrl2_lvExpirations_ctrl0_lbExpiration
    //Среда       ctl00_ucSelector_lvGroupsExpirations_ctrl3_lvExpirations_ctrl0_lbExpiration
    //Четверг     ctl00_ucSelector_lvGroupsExpirations_ctrl4_lvExpirations_ctrl0_lbExpiration
    ...
    public ShowCallPutEOW getCallPutWeek() {//Смотрим Колл-Пут недельного контракта
        ...
        //click(clickmenu);
        //pause(5000);
        WebElement nextElement2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='ctl00_ucSelector_lvGroupsExpirations_ctrl5_lvExpirations_ctrl0_lbExpiration']")));
        nextElement2.click();
        //click(callputweek);
        //pause(5000);
