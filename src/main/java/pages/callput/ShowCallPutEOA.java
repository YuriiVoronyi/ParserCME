...
public class ShowCallPutEOA extends BasePage {

    public ShowCallPutEOA(WebDriver driver) {
        super(driver);
    }
...
//=============================================================================================
            ...
            connection.close();
            System.out.println("EOA calls and puts loaded into database.");
        } catch (Exception e) {
        ...
        //click(waytotuesday);
        //pause(5000);
        return new ShowCallPutEOB(driver);
