...
public class ShowCallPutEOC extends BasePage {

    public ShowCallPutEOC(WebDriver driver) {
        super(driver);
    }
    ...
    WebElement waytothursday;

    public ShowCallPutEOD loadingCallPut() {
...
//=============================================================================================
            ...
            connection.close();
            System.out.println("EOC calls and puts loaded into database.");
        } catch (Exception e) {
        ...
        //click(openmenu);
        //pause(5000);//**********************************2000
        WebElement nextElement4 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='ctl00_ucSelector_lvGroupsExpirations_ctrl4_lvExpirations_ctrl0_lbExpiration']/div[1]")));
        nextElement4.click();
        //click(waytothursday);
        //pause(5000);
        return new ShowCallPutEOD(driver);
    }
}
