...
public class ShowEOB_MaxPain extends BasePage {

    private BasePage balObj;

    public ShowEOB_MaxPain(WebDriver driver, BasePage balObj) {
        super(driver);
        this.balObj = balObj;
    }
    ...
    public OpenInteresSB getMaxPain(BasePage obj) {
        ...
        System.out.println("The EOB balance is found, it is equal to " + maxpain);
