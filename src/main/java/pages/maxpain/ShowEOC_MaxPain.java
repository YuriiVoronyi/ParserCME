...
public class ShowEOC_MaxPain extends BasePage {

    private BasePage balObj;

    public ShowEOC_MaxPain(WebDriver driver, BasePage balObj) {
        super(driver);
        this.balObj = balObj;
    }
    ...
    public OpenInteresSB getMaxPain(BasePage obj) {
        ...
        System.out.println("The EOC balance is found, it is equal to " + maxpain);
