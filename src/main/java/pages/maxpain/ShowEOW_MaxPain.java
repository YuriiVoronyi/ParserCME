...
public class ShowEOW_MaxPain extends BasePage {

    private BasePage balObj;

    public ShowEOW_MaxPain(WebDriver driver, BasePage balObj) {
        super(driver);
        this.balObj = balObj;
    }
    ...
    public OpenInteresSB getMaxPain(BasePage obj) {
        ...
        System.out.println("The EOW balance is found, it is equal to " + maxpain);
